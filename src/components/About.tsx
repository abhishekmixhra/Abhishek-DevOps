      ...
      <div className="container mx-auto px-6 max-w-7xl">
        ...
        <div ref={statsRef} className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
          {[
            ...
            <div key={stat.key} className="text-center p-6 bg-gray-800/50 backdrop-blur-sm rounded-2xl border border-gray-700/30 hover:border-blue-500/50 transition-all duration-300 hover:scale-105">
